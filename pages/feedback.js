                                                ...
                                                <ul className="flex items-center justify-center space-x-2">
                                                    <li className="flex flex-col items-center space-y-2">
                                                        <div className='items-center justify-center'>
                                                            <img className="w-10 text-black rounded-full"
                                                                src='./assest/user.png' />
                                                        </div>
                                                        <p className="text-xs text-gray-500 ">{item.name}</p>
                                                        <p className="text-xs text-left text-gray-500">{item.email}</p>
                                                        <p className="block p-1 text-sm font-bold sm:p-1 sm:text-base">
                                                            {item.message}                            </p>
                                                        <p className="mx-1 text-xs text-right text-gray-500 sm:text-center mdi mdi-plus mdi-18px">{item.timestamp.split('T', 1)}</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div className="flex">
                                                <ul className="flex items-center justify-center space-x-2">
                                                    <li className="flex flex-col items-center space-y-2">
                                                        ...
                                                        <p className="text-xs font-bold text-gray-500 ">Amman</p>
                                                        <p className="text-xs font-bold text-left text-gray-500">{item.date}</p>
                                            ...
                                            <div className="flex">
                                                <ul className="flex items-center justify-center space-x-2">
                                                    <li className="flex flex-col items-center space-y-2">
                                                        ...
                                                        <p className="text-xs font-bold text-gray-500  hover:scale-110">Amman</p>
                                                        <p className="text-xs font-bold text-left text-gray-500 hover:scale-110">{item.date}</p>
