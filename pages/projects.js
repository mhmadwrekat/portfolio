...
const projects = () => { 
    return (
        <section translate='no'>
            ...
            {/* TITLE */}
            <section>
                <div id="Projects" class=" text-blue-600" >
                    <div>
                        <div className="lg:px-10 sm:px-0 sm:pt-10 text-base sm:text-3xl text-center font-serif font-bold self-center ...">
<div
className="p-5 mx-6 bg-white rounded-xl shadow-2xl lg:rounded-l-lg lg:rounded-r-none opacity-95 lg:mx-6">
            ...
            <section className='grid grid-cols-1 justify-items-center ... gap-10 py-10 mx-5 sm:mx-0 sm:grid-cols-3 sm:gap-5'>
                {/* PROJECT 5 */}
                <section>
                    <div class="w-56 lg:w-80 bg-white opacity-95 rounded-xl shadow-2xl p-2">
...
<a href="https://soufatak.vercel.app/">
View
</a>
</button>
                            <p className='pl-1'>
                                <p class="my-2 text-gray-500 text-xs sm:text-sm">
                                A page to display handmade woolen products with types and prices .
                                </p>
                            </p>
                        </div>
                    </div>
...
absolute top-28 left-16 lg:top-48 lg:left-24 lg:px-10 lg:py-2
bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-6 rounded-full">
<a href="https://cella-center.vercel.app/">
View
</a>
</button>
                            <p className='pl-1'>
...
absolute top-28 left-16 lg:top-48 lg:left-24 lg:px-10 lg:py-2
bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-6 rounded-full">
<a href="https://fifa-world-cup-22.vercel.app/">
View
</a>
</button>
...
absolute top-28 left-16 lg:top-48 lg:left-24 lg:px-10 lg:py-2
bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-6 rounded-full">
<a href="https://priceless-swartz-6b6f00.netlify.app/">
View
</a>
</button>
                            <p className='pl-1'>
...
<div class="w-56 lg:w-80 bg-white opacity-95 rounded-xl shadow-2xl p-2">
<div class="text-center relative overflow-hidden rounded-2xl shadow-2xl">
<p class="block mt-1 text-xs sm:text-xl uppercase leading-tight font-medium text-black">
Article Template
</p>
<div class="uppercase tracking-wide text-xs sm:text-sm text-red-700 pb-1 sm:pb-0 font-semibold">RESPONSIVE</div>
<img class="object-cover w-full sm:h-48 h-28 rounded-xl"
src="./assest/article.jpg" alt="Article" />
<button class="
absolute top-28 left-16 lg:top-48 lg:left-24 lg:px-10 lg:py-2
bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-6 rounded-full">
