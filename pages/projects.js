...
const projects = () => {
    return (
        <>
            ...
            {/* TITLE */}
            <section>
                <div class="grid grid-cols-2 gap-10 text-sky-900">
                    <img src='https://abhedyak.github.io/images/back-end-developer.svg' class="object-cover sm:h-6/6 w-6/6 ..." />
                    <div class="flex items-stretch ...">
                        <div></div>
                        <div className="text-sm sm:text-3xl text-left sm:text-center font-serif font-bold self-center ...">
                            <p className=''>
                                My Latest Projects
                            </p>
                            <br></br>
            ...
            <section className='sm:grid sm:grid-cols-2 sm:gap-4'>
                ...
                <section className='pt-20'>
                    <div class="max-w-md mx-auto bg-white rounded-xl shadow-2xl overflow-hidden md:max-w-2xl">
                        <div class="md:flex">
                            <div class="pl-20 md:pl-0 md:shrink-0">
