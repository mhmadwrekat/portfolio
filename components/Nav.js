...
<meta name="description" content="Web Developer - Jordan - Amman" />
            ...
            <nav class="bg-white opacity-80 border-gray-200 px-2 sm:px-4 py-4 rounded" translate='no'>
...
hover:bg-yellow-500 bg-yellow-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ml-4 md:mr-0">
                    ...
                    <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-2" id="mobile-menu-4">
                        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 text-black md:text-sm md:font-medium">
                        <li>
<button>
    <a href="#Skills" class="cursor-grab hover:scale-110 font-bold block py-2 pr-4 pl-3 text-black hover:text-yellow-700 md:border-0 md:p-0">
    Skills
    </a>
</button>
</li>
                                <li>
<button>
    <a href="#Projects" class="cursor-grab hover:scale-110 font-bold block py-2 pr-4 pl-3  hover:text-yellow-700 md:border-0 md:p-0">
    Projects
    </a>
</button>
</li>
<li>
<button>
    <a href="#Message" class="cursor-grab hover:scale-110 font-bold block py-2 pr-4 pl-3  hover:text-yellow-700 md:border-0 md:p-0">
    Message Me
    </a>
</button>
                                </li>
                    ...
                    {
    (weathers.length > 0)?
    <p class='md:order-2 text-sm sm:text-lg font-bold font-sans pl-3 text-yellow-500 hover:text-yellow-700 cursor-grab hover:scale-110'>⛅ {weathers[0].max_temp} °C</p>            
:<></>
}
                </div>
            </nav>
            <div translate='no' class='hidden mobile-menu md:hidden w-full bg-white opacity-80 border-gray-200'>
                <ul class="flex flex-col md:flex-row text-black md:space-x-0 md:mt-0 md:text-sm md:font-medium text-center">
                <button>
    <a href="#Skills" class="cursor-grab hover:scale-110 font-bold block py-2 pr-4 pl-3  hover:text-yellow-700 md:border-0 md:p-0">
    Skills
    </a>
</button>
                <button>
