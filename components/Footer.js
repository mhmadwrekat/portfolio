                    ...
                    <div class="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <div class="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8 font-bold">
                                <Link href="/feedback">
                                    <a href="" class="cursor-help hover:text-violet-600 hover:scale-110 focus:underline focus:outline-none text-base">FeedBacks</a>
                                </Link>
                            </div>
                            ...
                            <div class="flex items-center mt-6">
                                <p class="font-serif text-xs cursor-help hover:text-violet-600 hover:scale-110 leading-4">2022 <span class="font-serif">MHMAD
                                    WREKAT</span></p>
                                <div class="border-l border-gray-800 pl-2 ml-2">
                                    <p class="font-serif text-xs cursor-help hover:text-violet-600 hover:scale-110 leading-4">Inc. All Rights Reserved</p>
                                </div>
                            </div>
                        </div>
                    </div>
