...
const Footer = () => {
  return (
    <>
      <section
        className="opacity-90 bg-white text-yellow-500"
        id="profilefoot"
        translate="no"
      >
        <div>
          <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12">
            <div className="flex flex-col items-center justify-center">
              <Link href="/">
                <img
                  className="cursor-help	hover:scale-110 animate-pulse"
                  src="./assest/project.png"
                  width="50"
                  height="40"
                />
              </Link>
              <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8 font-bold">
                <Link href="/feedback">
                  <a
                    href=""
                    className="cursor-help hover:text-yellow-700 hover:scale-110 focus:underline focus:outline-none text-base"
                  >
                    FeedBacks
                  </a>
                </Link>
              ...
              <div className="flex items-center gap-x-8 mt-6">
                ...
                >
                  <img
                    ...
                    className="w-6 h-6 fill-current cursor-alias"
                  />
                </a>
                <a
                  className="rounded-full hover:scale-125"
              ...
              <div className="flex items-center mt-6">
                <p className="font-serif text-xs cursor-help hover:text-yellow-700 hover:scale-110 leading-4">
