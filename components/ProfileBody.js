            ...
            <div>
              ...
              <Fade triggerOnce delay={1000}>
                <p className="flex items-center justify-center pt-4 text-base font-bold lg:justify-start">
                  <svg
                    className="h-4 pr-4 fill-current text-yellow-500"
              ...
              <Fade triggerOnce delay={1500}>
                <p className="flex items-center justify-center pt-2 pr-5 text-xs text-white-600 lg:text-sm lg:justify-start">
                  <svg
                    className="h-4 pr-4 fill-current text-yellow-500"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
