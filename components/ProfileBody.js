  ...
  return (
    ...
    <div className=' pt-20 sm:pt-0'></div>
             <div className="flex flex-wrap items-center h-auto max-w-4xl mx-auto lg:h-screen lg:my-0">
                 <div id="profile"
                     className="w-full mx-6 text-black bg-white rounded-lg shadow-2xl lg:w-3/5 lg:rounded-l-lg lg:rounded-r-none opacity-95 lg:mx-0">
                     <div className="p-4 text-center md:p-12 lg:text-left">
                         ...
                         <div className="w-4/5 pt-3 mx-auto border-b-2 opacity-25 border-yellow-500 lg:mx-0"></div>
                         <Fade triggerOnce delay={1000}>
                             <p className="flex items-center justify-center pt-4 text-base font-bold lg:justify-start">
                                 <svg
                                     className="h-4 pr-4 fill-current text-yellow-500" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 20 20">
                                     <path
                         ...
                         <Fade triggerOnce delay={1500}>
                             <p
                                 ...
                                 <svg className="h-4 pr-4 fill-current text-yellow-500" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 20 20">
                                     <path
                         ...
                         <Fade triggerOnce delay={2500}>
                             <div className="pt-12 pb-8">
                                 <a target='_balnk' href="https://wa.me/+962798596928">
                                     ...
                                     <button
                                         className="px-4 py-2 font-bold text-gray-200 rounded-full cursor-alias bg-yellow-500 hover:bg-yellow-700">
                                         Text Me!!
                                     </button>
                                 </a>
                             </div></Fade>
